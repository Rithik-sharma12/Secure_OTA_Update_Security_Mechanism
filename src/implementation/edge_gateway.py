...
DEFAULT_RELEASE_ARTIFACT = os.getenv('OTA_GATEWAY_RELEASE_ARTIFACT', '').strip()
...
def create_release_locked(
    ...
    source_artifact, firmware_payload = load_release_artifact(normalized_version, source_file_path)
